...
void read_ntuple(std::string str){
  ...
  ttree->SetBranchAddress("mcparticlecount", &mcparticlecount);
  ttree->SetBranchAddress("mcpecount", &mcpecount);
  ttree->SetBranchAddress("mcnhits", &mcnhits);
  ttree->SetBranchAddress("mcpdgs", &mcpdgs);
  ttree->SetBranchAddress("mckes", &mckes);
  ttree->SetBranchAddress("mcxs", &mcxs);
  ttree->SetBranchAddress("mcys", &mcys);
  ttree->SetBranchAddress("mczs", &mczs);
  ttree->SetBranchAddress("mcus", &mcus);
  ttree->SetBranchAddress("mcvs", &mcvs);
  ttree->SetBranchAddress("mcws", &mcws);
...
int main(int argc, char**argv){
  ...
  TH1F* h_mcparticlecount = new TH1F("","",300,0,300);
  ...
  // same thing
    ...
    for (int i=0;i<nentries;i++){
      ...
      h_mcparticlecount->Fill(mcparticlecount);
  ...
  if (ifOutputRoot){
    ...
    h_mcparticlecount->Write("h_mcparticlecount");
